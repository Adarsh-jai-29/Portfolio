...
export const projects = [
    {
      title: "AdjStore",
      description: "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Facere alias atque repellendus minus saepe. A modern e-commerce platform with advanced features.",
    ...
    },
    {
      ...
      description: "Developed a comprehensive Task Management System featuring user authentication, full CRUD operations for tasks, and advanced categorization based on task status and priority.",
      techStack: "Next.js, TypeScript, Clerk (authentication), Prisma, Mongoose",
