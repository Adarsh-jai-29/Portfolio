...
export const Project = ({ 
  ...
  return (
    <div className="group relative bg-gray-800/50 backdrop-blur-sm rounded-2xl shadow-xl hover:shadow-2xl hover:shadow-purple-500/20 transition-all duration-500 overflow-hidden border border-purple-500/20 hover:border-purple-500/40 flex flex-col">
      {/* Project Image */}
      ...
      <div className="p-4 sm:p-6 flex-1 flex flex-col">
        ...
        {/* Description */}
        <p className="text-gray-300 mb-4 leading-relaxed text-sm sm:text-base line-clamp-3 flex-1">
          {description}
        </p>
        ...
        <div className="flex gap-2 mt-auto">
          {liveUrl && (
            <a
              ...
              className="flex-1 flex items-center justify-center gap-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white px-3 py-2 rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all duration-300 font-medium text-xs sm:text-sm hover:shadow-lg hover:shadow-purple-500/50"
            >
